...
required artifacts. Respect the direct-source pipeline order. Only the final source-map stage may
publish the source-map and manifest entries assigned to it.
